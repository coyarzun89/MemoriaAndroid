...
%\draft %Notar que la numeración cambia, dejando los números de página en la parte superior (a no ser que sea comienzo de capítulo).
%\nobib
%\nofront
%\nolistoftables \nolistoffigures
% ---------------------------------------------------------------------------------------------------------------
...
% ---------------------------------------------------------------------------------------------------------------
\title{Análisis de herramientas para mejorar la calidad de aplicaciones para Android}
\author{Cristopher Nicolás Oyarzún Altamirano}
\end{center}
...
\dedicate{``Dedicado a mis padres, Guillermo y Alicia, que se han sacrificado por darme el mejor de los regalos, la educación"\\-- Cristopher Oyarzún}	
