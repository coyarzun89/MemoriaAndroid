...
\item ¿La aplicación mantiene el estado? La Activity no debería perder nada que el usuario haya ingresado en la UI.
\end{itemize}
...
\caption{Gráfico con la distribución de tamaños de pantalla durante el mes de Abril del 2014. \cite{1}, }
\label{fig:Fig6}
\end{figure}
...
\caption{Gráfico con la distribución de densidades de pantalla durante el mes de Abril del 2014.\cite{13}}
\label{fig:Fig8}
\end{figure}
