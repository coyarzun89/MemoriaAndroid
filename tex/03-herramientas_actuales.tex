...
Para la distribución también es necesario sólament subir el APK y comenzar a invitar testers.
...
\caption{Vista del sistema de reporte de crashes de ACRA}
\label{fig:Fig17}
\end{figure}
