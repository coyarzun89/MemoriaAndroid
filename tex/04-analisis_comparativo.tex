...
En el siguiente capítulo se llevará a cabo la implementación de las herramientas más destacadas en una aplicación que se encuentra disponible en la tienda oficial de Google, Seahorse.

\section{Análisis Comparativo entre las Herramientas de Testing Unitario}
\subsection{Framework de Testing de Android: JUnit, Assertions y Mocks.}
\subsubsection{Ventajas}
\begin{itemize}
\item Acceso al Framework de Android, por lo que los tests son lo más realista posible.
...
El Framework de Testing de Android es el método oficial que ofrece Google para realizar testing unitario y entre sus herramientas se encuentran utilidades para trabajar con Mocks, Assertions que permiten realizar comprobaciones de vistas y otras extensiones basadas en JUnit. Primero se carga la aplicación en un dispositivo, y luego los tests se ejecutan. Debido a que se ejecutan en un dispositivo que cuenta con el sistema operativo Android, se pueden usar todos los métodos que ofrece el framework de Android, por lo que los test son lo más cercano a la realidad. Aunque esto también le juega en contra, ya que compilar la aplicación, subir la aplicación a un dispositivo o emulador, y luego ejecutar los test, es un proceso muy lento.
...
\begin{itemize}
\item Gratuito: No se debe pagar nada para acceder a todas sus características. [Si, No]

\item Código abierto: Se tiene acceso al código fuente. [Si, No]

\item Madurez: Tiempo de desarrollo y estabilidad que tiene la herramienta. [Alta, Media, Baja]

\item Duración: Cantidad de tiempo que se demoran en ejecutar los tests. [Alta, Media, Baja]

\item Documentación: Calidad de la documentación relacionada con la herramienta. [Buena, Media, Mala]

\item Usabilidad: Nivel de complejidad en integrar y usar la herramienta en una aplicación. [Fácil, Medio, Difícil]
\end{itemize}
...
\item Los test son independientes del proceso en el que la aplicación testeada funciona. Esto permite realizar tests en que se puede interactuar con otras aplicaciones, como por ejemplo, con la aplicación de la cámara.
...
\item Usabilidad: Nivel de complejidad en integrar y usar la herramienta en la aplicación. [Fácil, Medio, Difícil]

\item Sincronizado con \textit{UI thread}: Los test se sincronizan con el \textit{UI thread}. [Si, No]
\end{itemize}
...
\hline
uiautomator & Media & Medio & No \\
\hline
Robotium & Buena & Fácil & No \\
\hline
Espresso & Media & Medio & Si \\
\hline
\end{tabular}
...
Si bien, las principales herramientas de testing unitario y de interfaz gráfica ya se analizaron, existen otras herramientas que son muy difíciles de clasificar en alguna categoría, y que no son comparables entre sí, pero que si merecen ser mencionadas.  
\subsection{Monkey}
\subsubsection{Ventajas}
\begin{itemize}
...
\item Precio: Valor del plan más económico ofrecido por la herramienta de forma mensual. [Valor en dólares]

\item Madurez: Tiempo de desarrollo y estabilidad que tiene la herramienta. [Alta, Media, Baja]

\item Multiplataforma: Soporte para más de una plataforma, no sólo Android. [Si, No]

\item Feedback: Los usuarios de prueba pueden enviar retroalimentación al desarrollador. [Si, No]

\item Distribución: Es masiva si los usuarios pueden acceder por su cuenta, sin invitaciones del desarrollador. Es limitada si el desarrollador es el que tiene que invitar a los usuarios. [Masiva, Limitada]

\item Testing incluye video: Además de realizar las tareas y responder las preguntas solicitadas por el desarrollador, el usuario adjunta un video de todo el proceso. [Si, No]
\end{itemize}
...
\hline
HockeyApp & Si & Si & Limitada\\
\hline
AppBlade & Si &  Si & Limitada\\
\hline
\end{tabular}
...
\item Usabilidad: Nivel de complejidad en integrar y usar la herramienta con la aplicación. [Fácil, Media, Difícil]

\item Calidad del reporte: Nivel de detalle en cada reporte de crash. [Baja, Media, Alta]
...
\hline
Google Play Console & Alta & Fácil & Baja\\
\hline
